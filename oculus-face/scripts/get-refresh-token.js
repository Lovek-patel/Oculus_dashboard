...
//
// Open the printed URL, sign in with the Google account whose calendar/tasks
// you want, approve access. You'll be redirected to a localhost URL that
// this script is already listening on — it grabs the code automatically and
// prints a refresh token. Save that as the GOOGLE_REFRESH_TOKEN secret.
